...
export default function FeaturesPage() {
  ...
  const members: Member[] = [
    ...
    // Repeat to make 20 members (4 rows x 5 columns)
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white">
        {/* Breadcrumb Section */}
        <section className="bg-white border-b border-gray-200 min-h-screen w-screen flex items-center justify-center">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full text-center">
            <p className="text-sm text-gray-500 mb-2">Home-Members</p>
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-[#001F54] mb-8">
            ...
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 mb-4">
              ...
              <div className="relative">
                <select
                  ...
                  className="appearance-none bg-white border-2 border-gray-300 text-[#001F54] font-medium py-2 px-4 pr-8 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary cursor-pointer"
                >
        ...
        <section className="py-12 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex justify-center items-center gap-3 mt-12">
              <svg
                className="w-6 h-6 text-primary fill-none"
                stroke="currentColor"
                strokeWidth={2}
                viewBox="0 0 24 24"
              >
        ...
        {/* Features Section - Second Component */}
      </div>
      <DownloadApp />
      <Footer />
    </>
